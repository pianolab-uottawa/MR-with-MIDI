export const intervalCPositionBroken = [
    {scoreID: "intervalCPositionBroken", scoreIDformatted:"intervalCPositionBroken",noteGroupFormatVariant:""},//add prefix to ensure the ID is unique in DOM
    ...
    {score:" G G G|", imageSizeFactor:"1.2", staffWidth:"60" , eventDuration:300, eventName: "Practice 1 shows on screen"},
